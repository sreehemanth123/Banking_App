...
<body>
    ...
    <nav class="navbar py-2 navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#"> THE SPARKS BANK <img src="logos/bank.jpg" alt="Bank" width="50" height="50"></a>
    ...
    <div class="d-grip gap-2 col-6 mx-auto text-center p-3 mb-2">
        ...
        <a href="history.php"><button type="button" class="btn btn-dark btn-lg mb-3">View Payments History</button></a>
    </div>
    </div>
